...
class CaptainCookStepShuffleDataset(Dataset):
    ...
    def __init__(self, config, phase):
        ...
        # Load the recording ids from the json file
        self._recording_ids_file = f"recordings_data_split_combined.json"
        ...
        for recording_id in self._recording_ids:
            ...
            random.shuffle(list(self._error_step_dict.keys()))
            ...
            if phase == 'train':
                ...
                self._val_error = error_step_indices[self._split_proportion_error[0]:self._split_proportion_error[1]]
