...
plots_path = "plots_main_errors"
os.makedirs(plots_path, exist_ok=True)
confusion_matrix_path = "confusion_matrix_main_errors"
os.makedirs(confusion_matrix_path, exist_ok=True)
# Old Labels
# path = "/home/sxa180157/projects/error_dataset/supervised_benchmarks/Supervised-Benchmarks-for-Error-Dataset/sl_methods/trained_model_outputs/checkpoints_only_main_errors/2023-09-26-12-18-46"
# New Labels
# 20 Epochs
...
path = "/home/sxa180157/projects/error_dataset/supervised_benchmarks/Supervised-Benchmarks-for-Error-Dataset/sl_methods/trained_model_outputs/checkpoints_only_main_errors/new_labels/epoch_50_3_error"

all_files = get_npz_files(path)
all_rows = [["Method Name", "Accuracy", "Precision", "Recall", "F1 Score", "AUC Score"]]
...
for file in all_files:
    ...
    plt.savefig(
        f"{confusion_matrix_path}/{method_name}.pdf", bbox_inches="tight", format="pdf"
    )

    this_row.extend([accuracy, precision, recall, f1, roc_auc])
    all_rows.append(this_row)

csv_file_path = "metrics_main_errors.csv"
