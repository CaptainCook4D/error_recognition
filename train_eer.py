...
def train_eer_model(train_loader, val_loader, device, config, test_loader=None):
...
def train_sub_step_test_step_er(config):
    ...
    train_eer_model(train_loader, val_loader, device, config)
...
def train_step_test_step_er(config):
    ...
    train_eer_model(train_loader, val_loader, device, config, test_loader=test_loader)
